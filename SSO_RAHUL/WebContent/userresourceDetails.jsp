...
<html>
<title>USER RESOURCE DETAILS</title>
  ...
  <tr>
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td><a href="#"><img src="images/index_13.gif" alt="" width="102" height="41" border="0"></a></td>
        <td><a href="#"><img src="images/index_14.gif" alt="" width="102" height="41" border="0"></a></td>
        <td><a href="#"><img src="images/index_15.gif" alt="" width="102" height="41" border="0"></a></td>
      </tr>
    </table></td>
  </tr>
  <tr>
    <td><table width="100%" border="2" bordercolor="black" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <tr><td> ResourceId </td><td>Resource Name</td> <td>ResourcePath</td></tr>
        <%
		...
		%>
			...
			<tr><td><%=rs1.getResId()%></td>
			<td><%=rs1.getResName()%></td>
			<td><%=rs1.getPath()%></td></tr>
			
		
		<tr><td>PERMISSIONS</td></tr>
		<tr><td>READ :<%=rs1.getRead() %></td><td>Write:<%=rs1.getWrite() %></td><td>Execute:<%=rs1.getExecute() %></td>
        </tr>
