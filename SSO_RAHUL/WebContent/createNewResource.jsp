						...
						<td width="43%"><table width="100%" border="0"
								...
								<tr>
									...
									<td width="24%"><a href="index.html"><img
											src="images/logout.png" alt="" width="40" height="40"
											border="0">
									</a>
									</td>
								</tr>
	...
	<table width="1000" border="0" align="center" cellpadding="0"
		...
		<tr>
			<td class="p2"><table width="100%" border="0" cellpadding="0"
					cellspacing="10">
					<tr>
						<td><form name="createNewResource" action="createNewResource" onsubmit="return validate()">
								...
								<table width="100%" border="0" cellpadding="0" align="center"
									...
									<tr>
										<td><table width="100%" border="0" cellpadding="4"
												cellspacing="1">
												<tr>
													<td align="Right"><b> RESOURCE ID: <span
															class="style1">*</span>
													</b>
													</td>
													<td width="70%"><input type="TEXT" name="resId"
														id="resId" style="width: 40%";"></td>
												</tr>
												<tr>
													<td align="Right"><b> RESOURCE NAME: <span
															class="style1">*</span>
													</b>
													</td>
												...
												<tr>
													<td align="Right"><b> RESOURCE PATH: <span
															class="style1">*</span>
													</b>
													</td>
													<td><input type="TEXT" name="resPath" id="resPath"
														style="width: 40%";">
													</td>
												</tr>
