	...
	<table width="1000" border="0" align="center" cellpadding="0"
		...
		<tr>
			<td><table width="100%" border="0" cellspacing="0"
					cellpadding="0">
					<tr>
						<td><a href="users.jsp"><img src="images/back.png" alt=""
			...
			<td><table width="100%" border="2" bordercolor="black"
					...
					<tr>
						<td width="463" background="images/index_17.gif"><table
								...
								<tr>
									<td><a
										href="groupDetails.jsp?gname=<%=groupid%>&&uid=<%=uid%>"><%=groupid%></a>
									</td>
									<td><%=map.get(groupid)%></td>
								</tr>
								<tr>
									<td><font color="CCCC33">USER RESOURCES FROM <%=groupid%></font>
									</td>
								</tr>
								<tr>
							...
							<table width="100%" border="2" bordercolor="3E79A3">
								<tr>
									<td><font color="black"> ResourceId</font></td>
									<td><font color="black">ResourcePath</font>
									</td>
								</tr>
								<%
								...
								<tr>
									<td><a
										href="resourceDetails.jsp?resId=<%=rs1.getResId()%>&&uid=<%=uid1%>"><%=rs1.getResId()%></a>
									</td>
									<td><%=rs1.getPath()%></td>
								</tr>
								<%
						...
						<table>
							<tr>
								<td>
									<form method="post" action="addUserToGroup?uid=<%=uid1%>">
										Add to Group
										<%
							...
							<tr>
								<td>
									<form method="post" action="addResourceToUser?uid=<%=uid1%>">
										Add NEW RESOURCE
										<%
									...
									%>
										<select name="newresource">
											<%
												...
												for (String resid : resId) {
													...
													if (resexist != true) {
														out.println("<option >" + allresources.get(resid)
																+ "</option>");
										...
										</select> <input type="checkbox" name="read" checked="checked"
											value="r" /> <input type="checkbox" name="write" value="w" />
										<input type="checkbox" name="exec" value="e" /> <input
											type="submit" value="Add Resource to User" />
									</form></td>
							</tr>
