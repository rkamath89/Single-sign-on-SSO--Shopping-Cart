					...
					<tr>
						<td width="463" background="images/index_17.gif"><table
								...
								<tr>
									...
									<td>GROUP DESC</td>
									<%
										Map<String, String> groups = DAO.listOfGroups();
										Set<String> groupname = groups.keySet();
										for (String gname : groupname) {
									%>
								
								<tr>
									<td><a href="groupInfo.jsp?gname=<%=gname%>"><%=gname%></a>
									</td>
									<td><%=groups.get(gname)%></td>
									<td><a href="removeGroup?gname=<%=gname%>"">DELETE <%=gname%>
											FROM GROUPS</a>
									</td>
									<%
										}
								...
								<tr>
									<td><a href="createNewGroup.jsp">CREATE NEW GROUP</a>
									</td>
								</tr>
